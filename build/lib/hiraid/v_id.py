...
#
# 10/07/2024    v1.1.04     Updated model list
#
# 05/09/2024    v1.1.05     Updated model list
#
# 06/11/2024    v1.1.06     Updated model list
#
# 19/11/2024    v1.1.07     Updated model list
#
# -----------------------------------------------------------------------------------------------------------------------------------
...
class VId:
    ...
    models = {
                ...
                "RH10MHG"    :{ "v_id":"RH10MHG","type":"E1090H",    "model":["VSP E1090H"] },
                ...
                "VSP E1090H" :{ "v_id":"RH10MHG","type":"E1090H",    "model":["VSP E1090H"] },
                ...
                "M9SG"       :{ "v_id":"M9SG",   "type":"E590H",     "model":["M9SG"] },
                "RH20M2"     :{ "v_id":"RH20M2", "type":"B26",       "model":["VSP ONE B26"] },
                "RH20MH2"    :{ "v_id":"RH20M2", "type":"B28",       "model":["VSP ONE B28"] },
                "VSP ONE B26":{ "v_id":"RH20M2", "type":"B26",       "model":["VSP ONE B26"] },
                "VSP ONE B28":{ "v_id":"RH20MH2","type":"B28",       "model":["VSP ONE B28"] }
            }
    micro_ver = {
